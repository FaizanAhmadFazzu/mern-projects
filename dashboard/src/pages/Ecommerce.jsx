...
import { Button, Pie, SparkLine, Stacked, LineChart} from '../components';
    ...
    <div className='mt-24'>
        ...
        <div className='flex flex-wrap justify-center'>
            ...
            <div className='w-400 bg-white dark:text-gray-200 dark:bg-secondary-dark-bg rounded-2xl p-6 m-3'>
                ...
                <p className='text-xs cursor-pointer hover:drop-shadow-xl font-semibold rounded-lg w-24 bg-orange-500 py-0.5 px-2 text-gray-200 mt-10 '>16 APR, 2022</p>
