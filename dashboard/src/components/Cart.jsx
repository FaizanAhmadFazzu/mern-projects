...
const Cart = () => {
  ...
  return (
    <div className='bg-half-transparent w-full fixed nav-item top-0 right-0'>
      <div className="float-right h-screen duration-1000 ease-in-out dark:text-gray-200 transition-all dark:bg-[#484B52] bg-white md:w-100 p-8">
        ...
        </div>
        {
          cartData.map((item, index) => (
            <div key={index}>
              <div>
                <div className='flex items-cneter leading-8 gap-5 border-b-1 border-color dark:border-gray-600 p-4'>
                  <img className="rounded-lg h-80 w-24" src={item.image} alt="product-image" />
                  <div>
